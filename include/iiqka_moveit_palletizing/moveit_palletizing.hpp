...
class MoveitPalletizing : public rclcpp::Node
{
public:
  int pallet_id = 0;

  MoveitPalletizing()
  : rclcpp::Node("iiqka_moveit_palletizing") // instantiating Node
  {
  }

  void initialize()
  {
    // move_group_interface for moveit 
    move_group_interface_ = std::make_shared<moveit::planning_interface::MoveGroupInterface>(
      shared_from_this(),
      PLANNING_GROUP);

    // defining robotmodell, and configuring base link for Rviz
